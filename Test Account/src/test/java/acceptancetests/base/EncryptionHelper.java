...
public class EncryptionHelper {
    ...
    private static byte[] salt = new String("MyPGASalt").getBytes();
    private static int iterationCount = 40000;
    private static int keyLength = 128;
 
    public static String encrypt(String encryptionPassword,
            String originalPassword) throws Exception {
        SecretKeySpec key = createSecretKey(encryptionPassword.toCharArray(),
    ...
    public static String decrypt(String string,
            SecretKeySpec key) throws GeneralSecurityException, IOException {
